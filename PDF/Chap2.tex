...
\addcontentsline{toc}{section}{Chương 2: Thuật toán và chương trình trên Matlab}
...
\begin{enumerate}
    ...
    \item Người dùng sau đó có thể chọn \textit{Threshold = 0} để thực hiện nén không mất dữ liệu hoặc \textit{Threshold $>$ 0} để thực hiện nén mất dữ liệu và nhấn \textit{Update detail} để cắt ngưỡng. Hoặc người dùng có thể chọn \textit{Build graph} để kiểm tra các thông số nén trước khi cắt ngưỡng.
